...
public class FacultyMember implements Serializable {
    ...
    private static final int MAXIMUM_NUMBER_OF_LINKS = 250;
    /** The length of all pages that belong to this member combined. */
    private int contentLength = 0;

    /**
     * Construct a new instance of FacultyMember and index all of this member's
    ...
    /**
     * Return the main URL of the member.
     * @return mainURL
     */
